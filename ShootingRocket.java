 ...
 */
public class ShootingRocket extends SmoothMover
{
     ...
     */
    public ShootingRocket(int size)
    {
     ...
     */
    public ShootingRocket(int size, Vector velocity)
    {
        super(velocity);
        setSize(size);
    }
    ...
    private void breakUp() 
    {
        ...
        if (size <= 16) {
            ...
            ShootingRocket a1 = new ShootingRocket(size/2, speed1);
            ShootingRocket a2 = new ShootingRocket(size/2, speed2);
